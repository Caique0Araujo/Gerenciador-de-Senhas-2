...
public partial class HomeForm : Form
{
    ...
    private void FazerBackup(object sender, EventArgs e)
    {
        ...
        string srcFilename = "DBsenhas.db";
        string destFilename = "DBsenhasBP.db";
        ...
        var destfile = Path.Combine(backupFolder, destFilename);
        ...
        GC.WaitForPendingFinalizers();
           ...
           dialog.ShowDialog();
            ...
            if (dialog.ShowDialog() == DialogResult.OK)
            {
                ...
                string srcFileName = "DBsenhasBP.db";

                string destFileName = "DBsenhas.db";

                var backupFile = dialog.FileName;
                string backupPath = Path.GetDirectoryName(backupFile);

                var srcFile = Path.Combine(backupPath, srcFileName);
